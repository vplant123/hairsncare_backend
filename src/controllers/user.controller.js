...
const sendotp = asyncHandler(async (req, res) => {
    try {
        ...
        let existingUser = await User.findOne({ mobile: req.body.mobile, isVerified: true });
        if (existingUser) {
        ...
        return res.status(200).json(new ApiResponse(200, user || existingUser, "Otp sent successfully"))
