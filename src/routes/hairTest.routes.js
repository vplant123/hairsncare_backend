...
const { createHairTestForUser, updateHairTestStep, getHairTestDetail, getHairTest,createHairTestForUserStepWise} = require('../controllers/hairTest.controller.js');
...
router.post("/createHairTestForUserStepWise", verifyJwt, createHairTestForUserStepWise)
